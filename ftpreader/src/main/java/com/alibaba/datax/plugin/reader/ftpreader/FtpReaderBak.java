...
// * 该类将远程ftp文件落地
// */
//public class FtpReaderBak extends Reader {
...
//
//				String localFilePath ="/data/di_file/datax_ftp/"+ UUID.randomUUID()+"/";
...
//				String localFileName = localFilePath+substring;
...
//				}
//
////				String compress = readerSliceConfig.getString(com.alibaba.datax.plugin.unstructuredstorage.reader.Key.COMPRESS, null);
////				InputStream localInputStream = ShellCommandUnzip(compress, localFileName);
////				readerSliceConfig.set(com.alibaba.datax.plugin.unstructuredstorage.reader.Key.COMPRESS,null);
//
//				InputStream localInputStream  = null;
//				try {
//					localInputStream = new FileInputStream(localFileName);
//					UnstructuredStorageReaderUtil.readFromStream(localInputStream, fileName, this.readerSliceConfig,
...
//		}
//
//		InputStream ShellCommandUnzip(String compress,  String localFileName) {
//
//			String localFilePath ="/data/di_file/datax_ftp/"+ UUID.randomUUID()+"/";
//			File folder = new File(localFilePath);
//			if (!folder.exists()) {
...
//					cmd = "gunzip "+localFileName+" -d "+localFilePath;
//				}  else if ("zip".equalsIgnoreCase(compress)) {
//					 cmd = "unzip " + localFileName + " -d " + localFilePath;
//				} else {
//					return  new FileInputStream(localFileName);
//				}
//
//				ProcessBuilder processBuilder = new ProcessBuilder("/bin/bash", "-c", cmd).redirectErrorStream(true);
//				// 执行Shell命令
...
//				} else {
//					System.out.println("Failed to decompress the file. Exit code: " + exitCode);
//				}
